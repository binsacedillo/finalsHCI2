...
<head>
    ...
    <title>Add New Flight - Digital Pilot Logbook</title>
            ...
            <form>
                ...
                <div class="form-row">
                    ...
                    <select required>
                        ...
                        <option value="piper-pa34">Piper PA-34</option>
                        <option value="b737-sim">B737 Simulator</option>
                    </select>
                </div>

                <div class="form-row">
                    <label>Departure:</label>
                    <input type="text" placeholder="Enter ICAO code" required>
                </div>
                ...
                <div class="form-row">
                    ...
                    <input type="number" step="0.1" value="2.5" required>
                </div>
